...
<title>Bill</title>
<script>
if(winndow.history.forward(1)!=null)
...
<hr>
<div class="left-div"><h3>Thanks for shopping! </h3></div>
...
<div class="right-div-right"><h3>City:  <%=rs2.getString(11) %> </h3></div> 
<div class="right-div"><h3>Address:  <%=rs2.getString(10) %> </h3></div> 

<div class="left-div"><h3>State:  <%=rs2.getString(12) %> </h3></div>
<div class="right-div-right"><h3>Country:  <%=rs2.getString(13) %> </h3></div>  
