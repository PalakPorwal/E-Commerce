...
try
{
	...
	String q1="create table users(name varchar(100), mobilenumber bigint, email varchar(100)primary key,password varchar(100))";
	...
	String q4="create table message(id int AUTO_INCREMENT, email varchar(100), subject varchar(100), body varchar(500), PRIMARY KEY(id))";
