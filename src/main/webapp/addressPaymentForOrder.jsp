...
<div class="right-div">
<h3>Pay online on this grocerystore@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mobilenumber"  value="<%=rs2.getString(2) %>" placeholder="Enter mobile number" required>
